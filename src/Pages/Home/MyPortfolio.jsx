    ...
    <section className="portfolio--section" id="MyPortfolio">
      <div className="portfolio--container-box">
        <div className="portfolio--container">
          <p className="sub--title">Project Terbaru</p>
          <h2 className="section--heading">Portfolioku</h2>
        </div>
        <div>
          <button className="btn btn-github" onClick={() => (window.location.href = 'https://github.com/DefanZp?tab=repositories')}>
            <svg
      ...
      <div className="portfolio--section--container">
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            <div className="portfolio--section--img" onClick={() => (window.location.href = item.Result)}>
            ...
            <div className="portfolio--section--card--content">
              ...
              <p className="text-sm portfolio--link" onClick={() => (window.location.href = item.Project)}>
                {item.link}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
